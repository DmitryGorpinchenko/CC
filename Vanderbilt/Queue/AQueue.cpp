...
template <typename T, typename ARRAY> AQueue<T, ARRAY>::AQueue(size_t size)
    ...
    , count_(0)
{}
template <typename T, typename ARRAY> AQueue<T, ARRAY>::AQueue(const AQueue<T, ARRAY> &rhs) = default;
template <typename T, typename ARRAY> AQueue<T, ARRAY> &AQueue<T, ARRAY>::operator=(const AQueue<T, ARRAY> &rhs) = default;
